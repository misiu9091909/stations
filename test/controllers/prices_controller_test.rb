...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { fuel_type: @price.fuel_type, price: @price.price, station_id: @price.station_id }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { fuel_type: @price.fuel_type, price: @price.price, station_id: @price.station_id }
    assert_redirected_to price_path(assigns(:price))
  end
