...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { address: @station.address, brand_id: @station.brand_id, city: @station.city, latitude: @station.latitude, longitude: @station.longitude, name: @station.name }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { address: @station.address, brand_id: @station.brand_id, city: @station.city, latitude: @station.latitude, longitude: @station.longitude, name: @station.name }
    assert_redirected_to station_path(assigns(:station))
  end
